...
public class GolfBallNoiseSim extends GolfBallSim implements NewSim
	{
	private final static double NOISE_MAG = 0.1;

        public String getStat(boolean type){
            //return "score 2: "+westscore+":"+eastscore+			" shot: "+(int)shotclock,
            //return "" + this.westscore + " " + this.eastscore;
            if (type) //todo
                return this.estado;
            else
                return westscore+" "+eastscore+" "+((int)shotclock);                
        }        
